...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://github.com/palcarazm/component-lifecycle' }],
    ['meta', { property: 'og:image', content: 'https://github.com/palcarazm/component-lifecycle/card.png' }],
